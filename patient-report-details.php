...
<head>
    ...
    <title>Covid-19 Testing Management System | Dodati Flebotomistu</title>
...
<?php if($row['FinalReport']!=''):?>
  <tr>
    ...
    <tr>
    <th>Vrijeme dostavljanja izvjestaja</th> 
...
<div class="row">
                         <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary" align="center">Historija testiranja</h6>
                                </div>
                                <div class="card-body">
<?php if($num>0){
?>
...
<h4 align="center" style="color:red">Nema historije testiranja</h4>
         <?php } ?>           
