...
if ($result) {
echo '<script>alert("Flebotomist uspjesno kreiran.")</script>';
...
<head>
    ...
    <title>Covid-19 Testing Management System | Uredi flebotomiste</title>
...
?>                 
<h1 class="h3 mb-4 text-gray-800"><?php echo $row['FullName'];?>  Profil</h1>
                  ...
                  <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Ime i Prezime</label>
                                            <input type="text" class="form-control" id="fullname" name="fullname"  placeholder="Unesite vase ime i prezime" pattern="[A-Za-z ]+" title="letters only" value="<?php echo $row['FullName'];?>" required="true">
                                        </div>
                                        <div class="form-group">
                                             <label>Broj telefona</label>
                                  <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Unesite vas broj telefona" pattern="[0-9]{10}" title="10 numeric characters only" value="<?php echo $row['MobileNumber'];?>" required="true" >
