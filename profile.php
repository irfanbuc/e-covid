...
if (strlen($_SESSION['aid']==0)) {
  ...
  $email=$_POST['email'];
    ...
    echo '<script>alert("Profil je azuriran! ")</script>';
  }
  else
    {
      echo '<script>alert("Nesto nije u redu, pokusajte kasnije.")</script>';
    }
  }
...
<head>
    ...
    <title>Covid-19 Testing Management System | Admin Profil</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Admin Profil</h1>
...
?>
                                ...
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Datum registracije <?php  echo $row['AdminRegdate'];?></h6>
                                </div>
                                <div class="card-body">
