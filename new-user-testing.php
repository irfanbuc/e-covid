...
<head>
    ...
    <title>Covid-19 Testing Management System | Novi korisnik- testiranje</title>
  ...
  <div class="row">
                        ...
                        <div class="form-group">
                            <label>Ime i prezime</label>
                                            <input type="text" class="form-control" id="fullname" name="fullname"  placeholder="Unesite svoje ime i prezime..." pattern="[A-Za-z ]+" title="letters only" required="true">
                                        </div>
                                        <div class="form-group">
                                             <label>Broj telefona</label>
                                  <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Unesite broj telefona" pattern="[0-9]{10}" title="10 numeric characters only" required="true" onBlur="mobileAvailability()">
                                        ...
                                        <div class="form-group">
                                               <label>Broj nekog dokumenta</label>
                                            <input type="text" class="form-control" id="govtissuedid" name="govtissuedid" placeholder="Licna karta / vozacka / pasos" required="true">
                                        </div>
                                        <div class="form-group">
                                              <label>Maticni broj</label>
                                            <input type="text" class="form-control" id="govtidnumber" name="govtidnumber" placeholder="Unesite maticni broj" required="true">
                                        </div>
                          

                               <div class="form-group">
                                              <label>Adresa</label>
                                            <textarea class="form-control" id="address" name="address" required="true" placeholder="Unesite vasu adresu ovdje"></textarea>
                                        </div>
 <div class="form-group">
                                              <label>Drzava</label>
                                      <input type="text" class="form-control" id="state" name="state" placeholder="Unesite naziv drzave" required="true">
                                        </div>
                        ...
                        <div class="col-lg-6">
                           ...
                           <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Informacije o testu</h6>
                                </div>
                                <div class="card-body">
                             <div class="form-group">
                                            ...
                                            <option value="CB-NAAT">Seroloski</option>    
                                              </select>
                                        </div>

                                                      <div class="form-group">
                                            <label>Datum za test</label>
