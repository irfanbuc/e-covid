        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Covid19-Testing | Registrovani korisnici </h1>
...
<form method="post">
  <div class="row">
                       ...
                       <div class="form-group">
                                             <label>Registrovani broj telefona</label>
                                            <input type="text" class="form-control" id="regmobilenumber" name="regmobilenumber" placeholder="Unesti registrovani broj telefona" pattern="[0-9]{10}" title="10 numeric characters only" required="true" maxlength="10">
                                        </div>
<div class="form-group">
...
<h3 align="center" style="color:red">Rezultati po broju telefona "<?php echo $_POST['regmobilenumber'];?>"</h3>
<hr />
    <?php
...
<form name="newtesting" method="post">
 ...
 <div class="form-group">
                        ...
                        <div class="col-lg-6">
                           ...
                           <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Informacije o testiranju </h6>
                                </div>
                                <div class="card-body">
                             <div class="form-group">
                                            ...
                                            <option value="RT-PCR">RT-PCR</option>   
                                                      ...
                                                      <div class="form-group">
                                            <label>Vrijeme testiranja</label>
...
<?php } } else { ?>
<h4 align="center" style="color:red;">Nije pronadjeno</h4>
<?php }}?>
