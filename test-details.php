...
<head>
    ...
    <title>Covid-19 Testing Management System | Detalji testa</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Detalji testa #<?php echo intval($_GET['oid']);?></h1>
<div class="row">
<?php 
$testid=intval($_GET['tid']);
...
<!-- personal information --->
 ...
 <table class="table table-bordered"  width="100%" cellspacing="0">
    ...
    <tr>
    <th>Datum registracije profila</th> 
...
<!-- Test Information --->
                         <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Informacije testiranja</h6>
                                </div>
                                <div class="card-body">
...
<?php if($row['FinalReport']!=''):?>
  <tr>
    <th>Izvjestaj</th> 
    <td><a href="reportfiles/<?php echo $row['FinalReport'];?>" target="_blank">Preuzimanje</a></td>
    </tr>

    <tr>
    <th>Datum dostavljanja izvjestaja</th> 
...
<?php if($row['AssignedtoEmpId']==''): 
    ?>
      ...
      <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#assignto">Dodijeljen</button>
            </div>                                        
<?php else: 
...
<button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#takeaction">Poslati</button>
<?php 
endif;
endif;?>    
                                </div>
...
<div class="row">
                         <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary" align="center">Historija pracenja testiranja</h6>
                                </div>
                                <div class="card-body">
<?php if($num>0){
?>
...
<h4 align="center" style="color:red"> Nema historije pracenja </h4>
         <?php } ?>           
...
<form method="post">
          <p>  <select class="form-control" name="assignto" required="true">
            <option value="">Odaberite flebotomistu</option>
...
endwhile;
  ?>
            ...
            <option value="On the Way for Collection">Na putu za prikupljanje</option>
            <option value="Sample Collected">Prikupljeno</option>
            <option value="Sent to Lab">Poslano u labaratorij</option>
       ...
       <p id='reportfile'> Izvjestaj <span style="color:red; font-size:12px;">(Doc i PDF formati dozvoljeni)</span>    <input type="file" name="report" id="report"></p>
       <p>
